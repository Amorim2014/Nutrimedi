class UsersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user.save
        format.html { redirect_to @user, notice: 'Usuário criado co sucesso.' }
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:admin, :name, :inactive, :costumer_type, :email, :password, :password_confirmation )
    end
  end
